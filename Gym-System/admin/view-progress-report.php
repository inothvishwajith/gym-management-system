    ...
    <div class="row-fluid">
     ...
     <div class="widget-content">
              ...
              <div class="span4">
                <table class="">
                  ...
                  <tr>
                    ...
                    <tr>
                      <td>5021  Dalada Lane, Colombo 5</td>
                    </tr>
                    
                    <tr>
                      <td>Tel: 047-267-6011</td>
                    </tr>
                    <tr>
                      <td >Email: fit@perfectgym.com</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="row-fluid">
                ...
                <h4>GYM Member: <?php echo $row['fullname']; ?> <br> Weight Variation of <em style="color:green"><?php include 'actions/progress-percent.php';?>%</em> as per current updates! <i class="fa fa-spinner fa-spin" style="font-size:24px"></i><br/> <br/>  <br/></h4><p>Thank you for choosing our services.</p>
                </div>
                <div class="pull-right">
                  <h4><span>Approved By:</h4>
                  <img src="../img/report/stamp-sample.png" width="124px;" alt=""><p class="text-center">Perfect Gym Club</p> </div>
